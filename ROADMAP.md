...
| #18 | OCA doctor: surface Advance canaries + environment-specific checks (S1) | 7 | 5 | 6 | 3 | 6.0 | feature |
...
| #19 | Permission-first config for OCA-owned environment agents (S3) | 5 | 3 | 5 | 3 | 2.7 | feature |
...
| #32 | Context budget audit + instruction loading diet (S2) | 6 | 3 | 5 | 5 | 1.8 | tech-debt |
...
- Run timestamp: 2026-05-09T02:30:00Z
- Sources scanned: gh (23), agenda (0), wisdom (0), notes (0), changes (0), todos (0)
- Issues opened this run: 2 (#31 from ADV #70, #32 S2 restored)
- Field assignments this run: 5 (#17 retitled M6, #18 reframed S1, #19 split, #25/#26 reframed, #32 added)
- Items deferred: 0
- Boundary doc: docs/proposals/2026-05-08-cross-repo-boundary-audit.md (revised under "Advance owns everything achievable as a plugin; OCA owns only what plugins fundamentally can't do")
- Companion ADV issue: Sharper-Flow/Advance#103 (permission-first ADV agents)
