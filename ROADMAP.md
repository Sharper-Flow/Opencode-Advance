...
<!-- adv-triage generated: 2026-05-09T01:00:00Z | DO NOT EDIT MANUALLY -->
...
| # | Title | V | TC | RROE | E | WSJF | Labels |
|---|-------|---|----|------|---|------|--------|
| #25 | Deduplicate session debt scan across OCA and Advance (O4) | 5 | 4 | 5 | 2 | 3.5 | tech-debt |
| #17 | OCA skill guidance refresh (M6) | 6 | 4 | 6 | 3 | 3.2 | tech-debt |
| #26 | Config tree write dedup — OCA sole writer of opencode.json (O3) | 7 | 5 | 6 | 5 | 2.3 | tech-debt |
...
- Run timestamp: 2026-05-09T01:00:00Z
- Sources scanned: gh (21), agenda (0), wisdom (0), notes (0), changes (0), todos (0)
- Issues opened this run: 19
- Field assignments this run: 19
- Items deferred: 0
